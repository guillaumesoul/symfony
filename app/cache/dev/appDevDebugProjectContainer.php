...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'shorty.hashsluggenerator' => 'getShorty_HashsluggeneratorService',
            'shorty.sha1' => 'getShorty_Sha1Service',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'bitnami', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_bf9b705d31e4883143ae4db1b02b980712d36dbde144483b5f74745240c6c7a9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_bf9b705d31e4883143ae4db1b02b980712d36dbde144483b5f74745240c6c7a9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_bf9b705d31e4883143ae4db1b02b980712d36dbde144483b5f74745240c6c7a9');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/src/Shorty/FirstBundle/Resources/config/doctrine' => 'Shorty\\FirstBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Shorty\\FirstBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('FirstBundle' => 'Shorty\\FirstBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'shorty.hashsluggenerator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Shorty\FirstBundle\Services\HashSlugGenerator A Shorty\FirstBundle\Services\HashSlugGenerator instance.
     */
    protected function getShorty_HashsluggeneratorService()
    {
        return $this->services['shorty.hashsluggenerator'] = new \Shorty\FirstBundle\Services\HashSlugGenerator($this->get('shorty.sha1'));
    }

    /**
     * Gets the 'shorty.sha1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Shorty\FirstBundle\Services\Sha1 A Shorty\FirstBundle\Services\Sha1 instance.
     */
    protected function getShorty_Sha1Service()
    {
        return $this->services['shorty.sha1'] = new \Shorty\FirstBundle\Services\Sha1();
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/src/Shorty/FirstBundle/Resources/views', 'First');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/Resources/views');
        $instance->addPath('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/src/Shorty/FirstBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev',
            'kernel.logs_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'FirstBundle' => 'Shorty\\FirstBundle\\FirstBundle',
            ...
            'debug.container.dump' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/src/Shorty/FirstBundle/Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/../web',
            'assetic.write_to' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/mampstack-5.4.23-0/apache2/htdocs/symfony/app/cache/dev/doctrine/orm/Proxies',
